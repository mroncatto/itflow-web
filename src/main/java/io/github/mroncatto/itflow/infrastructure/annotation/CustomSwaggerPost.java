...
@Operation(summary = "", security = {
        ...
        @ApiResponse(responseCode = RESPONSE_201, description = SUCCESSFUL, content = @Content(mediaType = APPLICATION_JSON, schema = @Schema(implementation = Object.class))),
...
public @interface CustomSwaggerPost {
