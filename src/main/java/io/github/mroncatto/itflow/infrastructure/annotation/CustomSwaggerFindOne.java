...
@Operation(summary = "", security = {
        ...
        @ApiResponse(responseCode = RESPONSE_200, description = SUCCESSFUL, content = @Content(mediaType = APPLICATION_JSON, schema = @Schema(implementation = Object.class))),
...
public @interface CustomSwaggerFindOne {
